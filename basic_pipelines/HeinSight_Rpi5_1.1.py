...
if __name__ == "__main__":
    ...
    # heinsight = HeinSightHailo(vial_model_path="home/rogue-42/Downloads/chem_content.hef", contents_model_path="home/rogue-42/Downloads/chem_content.hef", use_hailo=True)
